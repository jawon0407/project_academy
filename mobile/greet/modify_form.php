			...
			<nav id="gnb">
				...
				<?
					...
					//$userid = $_SESSION['userid'];
						...
						if(!$userid){
				?>
				<ul class="flex space-x-4 mt-10 justify-center">
					<li class="rounded-lg bg-main">
						<a href="../login/login_form.php" class="block px-4 py-2 text-white w-full"> 로그인 </a>
					</li>
					<li class="rounded-lg bg-main">
						<a href="../member/join.html" class="block px-4 py-2 text-white w-full"> 회원가입 </a>
					</li>
				</ul>
				<?
					}else{
				...
				<ul class="flex space-x-4 mt-10 justify-center">
					<li class="rounded-lg bg-main">
						<a href="../login/logout.php" class="block px-4 py-2 text-white w-full"> 로그아웃 </a>
					</li>
					<li class="rounded-lg bg-main">
						<a href="../member/member_form_modify.php" class="block px-4 py-2 text-white w-full"> 회원정보수정 </a>
					</li>
				</ul>
				<? } ?>
			</nav>        
				...
				<div id="col2" class="mt-12">        
					<form name="board_form" method="post" action="insert.php?page=<?=$page?>"> 
						<div id="write_form">
							...
							<div id="write_title">
								<div class="col1">제목</div>
									<div class="col2">
										<input type="text" name="subject" class="w-full" value="<?=$item_subject?>">
									</div>
							</div>
						...
						<div id="write_button" class="btn_container flex self-end space-x-2 mt-5 mb-20">
							...
							<a href="#" onclick="check_input()" class="px-3 py-2 bg-blue-300 rounded-sm">
								확인
							</a>
						</div>
					</form>
