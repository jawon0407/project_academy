...
<?
    ...
    */
    ...
    if ($mode=="modify"){   // 댓글 수정일 때
        ...
        $sql = "update promotion_ripple set content='$ripple_content', regist_day='$regist_day' where num=$ripple_num"; // sql 업데이트문
    }
    else
    {
        // 레코드 삽입 명령
        $sql = "insert into promotion_ripple (parent, id, name, nick, content, regist_day) ";
